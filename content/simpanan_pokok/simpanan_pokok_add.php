...
<div class="row">
    <div class="col-md-12">
        <div class="card-box">
            <h4 class="m-t-0 m-b-30 header-title">Tambah Simpanan Pokok</h4>

            <form class="form-horizontal" role="form" action="content/simpanan_pokok/tambah_aksi.php" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="f_jumlah_bayar">
                    </div>
                </div>
                <div class="form-group row">
